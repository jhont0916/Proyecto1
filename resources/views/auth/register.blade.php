              ...
              <div class="card-body p-md-5 mx-md-4">
                ...
                <form action="{{route('register')}}" method="post">
                   ...
                   <p>Registro de usuario</p>
                    ...
                    <label class="form-label" for="form2Example2">No. Documento</label>
                    <input type="number" name="document_number" id="form2Example2" class="form-control"
                      placeholder="Ingresar N.o de documento" />
                  ...
                  <input type="text" name="telefono" id="telefono"
                   ...
                   <div data-mdb-input-init class="form-outline mb-4">
                    <label class="form-label" for="form2Example3">Nombre</label>
                  ...
                  <div data-mdb-input-init class="form-outline mb-4">
                    <label class="form-label" for="form2Example4">Correo</label>
                  ...
                  <div data-mdb-input-init class="form-outline mb-4">
                    <label class="form-label" for="form2Example5">Contraseña</label>
                    <input type="password" name="password" id="form2Example5" class="form-control" />
                    
                  </div>

                  <div data-mdb-input-init class="form-outline mb-4">
                    <label class="form-label" for="form2Example6">Confirmar Contraseña</label>
                    <input type="password" name="password_confirmation" id="form2Example6" class="form-control" />
                  ...
                  <div class="d-flex align-items-center justify-content-center pb-4">
                    <p class="mb-0 me-2">Ir al Inicio</p>
                    <a href="{{ route('casa') }}" data-mdb-button-init data-mdb-ripple-init class="btn btn-outline-danger">Inicio</a>
                  </div>
